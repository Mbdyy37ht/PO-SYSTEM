...
class ItemController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($items)
                ...
                ->addColumn('action', function ($item) {
                    $viewUrl = route('admin.items.show', $item);
                ...
                ->editColumn('minimum_stock', function ($item) {
                    return number_format($item->minimum_stock);
                })
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.items.index')
            ->with('success', "Item '{$validated['name']}' has been created successfully! ✨");
    }
    ...
    public function update(Request $request, Item $item)
    {
        ...
        return redirect()->route('admin.items.index')
            ->with('success', "Item '{$validated['name']}' has been updated successfully! 📝");
    }
    ...
    public function destroy(Item $item)
    {
        ...
        return redirect()->route('admin.items.index')
            ->with('success', "Item '{$itemName}' has been successfully deleted! 🗑️");
    }
}
