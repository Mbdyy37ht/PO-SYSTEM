<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Good Receipt Notes</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage goods received from suppliers</p>
            </div>
            <a href="{{ route('staff.good-receipt-notes.create') }}"
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-700 dark:text-blue-300">
                        <strong>Note:</strong> Good Receipt Notes can only be created from approved Purchase Orders. Once approved, GRN will automatically update inventory stock.
                    </p>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#grnTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('staff.good-receipt-notes.index') }}",
                    data: function(d) {
                ...
                language: {
                    emptyTable: `
                        <div class="py-12 text-center text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <p class="mt-2">No good receipt notes found.</p>
                            <a href="{{ route('staff.good-receipt-notes.create') }}" class="mt-2 text-green-600 hover:text-green-800 dark:text-green-400">
            ...
            $(document).on('submit', '.delete-form', function(e) {
                e.preventDefault();
                if (confirm('Are you sure you want to delete this Good Receipt Note? This action cannot be undone.')) {
                    this.submit();
                }
            });
        });
