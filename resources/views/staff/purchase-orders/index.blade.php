<x-app-layout>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg overflow-hidden">
            <div class="p-6">
                <div class="overflow-x-auto">
                    <table id="purchaseOrdersTable" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#purchaseOrdersTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('staff.purchase-orders.index') }}",
                    data: function(d) {
