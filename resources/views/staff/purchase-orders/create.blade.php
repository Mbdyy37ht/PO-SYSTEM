<x-app-layout>
    ...
    <div class="space-y-4 sm:space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
                <h2 class="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-200">Create Purchase Order</h2>
                <p class="mt-1 text-xs sm:text-sm text-gray-600 dark:text-gray-400">Fill in the details to create a new purchase order</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
            <div class="p-4 sm:p-6">
                <form action="{{ route('staff.purchase-orders.store') }}" method="POST" id="poForm">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="po_date" id="po_date" required
                                ...
                                class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm sm:text-base @error('po_date') border-red-500 @enderror">
                            @error('po_date')
                        ...
                        <div>
                            ...
                            <select name="supplier_id" id="supplier_id" required
                                class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm sm:text-base @error('supplier_id') border-red-500 @enderror">
