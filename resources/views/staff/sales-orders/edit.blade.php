<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Edit Sales Order</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update sales order details - {{ $salesOrder->so_number }}</p>
            </div>
            <a href="{{ route('staff.sales-orders.show', $salesOrder) }}"
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
            <div class="p-6">
                <form action="{{ route('staff.sales-orders.update', $salesOrder) }}" method="POST" id="poForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="so_date" id="so_date" required
                                value="{{ old('so_date', $salesOrder->so_date) }}"
                                class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('so_date') border-red-500 @enderror">
                            @error('so_date')
                        ...
                        <div>
                            ...
                            <select name="customer_id" id="customer_id" required
                                class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('customer_id') border-red-500 @enderror">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="notes" id="notes" rows="3"
                                ...
                                placeholder="Additional notes...">{{ old('notes', $salesOrder->notes) }}</textarea>
                        </div>
                    </div>
    ...
    <script>
        ...
        const existingItems = @json($salesOrder->details);
