<x-app-layout>
    ...
    <div class="space-y-4 sm:space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
                <h2 class="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-200">Edit Supplier</h2>
                <p class="mt-1 text-xs sm:text-sm text-gray-600 dark:text-gray-400">Update supplier information</p>
            </div>
