<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Suppliers</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage your suppliers</p>
            </div>
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-lg bg-white dark:bg-gray-800">
            <div class="mt-3">
                ...
                <div class="mt-3 text-center">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100">Delete Supplier</h3>
                    <div class="mt-2 px-7 py-3">
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Are you sure you want to delete supplier <strong id="deleteSupplierName" class="text-gray-900 dark:text-gray-100"></strong>?
                        </p>
                ...
                $('#suppliers-table').DataTable({
                    ...
                    drawCallback: function() {
                        ...
                        $('.delete-form').off('submit').on('submit', function(e) {
                            ...
                            // Get supplier name from the row
                            const supplierName = $(this).closest('tr').find('td:eq(1)').text();
