        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                <div class="flex items-center justify-between mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200">{{ $warehouse->name }}</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Warehouse Code</dt>
                        <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $warehouse->code }}</dd>
                    </div>

                    <div>
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Warehouse Name</dt>
                        <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $warehouse->name }}</dd>
                    </div>

                    <div>
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Contact Person</dt>
                        <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $warehouse->contact_person ?? '-' }}</dd>
                    </div>
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $warehouse->email ?? '-' }}</dd>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $warehouse->address ?? '-' }}</dd>
                    </div>

                    <div>
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Created At</dt>
                        <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $warehouse->created_at->format('d M Y H:i') }}</dd>
                    </div>

                    <div>
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Last Updated</dt>
                        <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">{{ $warehouse->updated_at->format('d M Y H:i') }}</dd>
                    </div>
                </div>
            </div>
        </div>
