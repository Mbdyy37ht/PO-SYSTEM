<x-app-layout>
    ...
    <div class="space-y-4 sm:space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
                <h2 class="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-200">{{ $delivery->delivery_number }}</h2>
                <p class="mt-1 text-xs sm:text-sm text-gray-600 dark:text-gray-400">Review Delivery</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        PO Date: {{ \Carbon\Carbon::parse($delivery->salesOrder->po_date)->format('d M Y') }}
                    </p>
                </div>
        ...
        <!-- Items Table Card -->
        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-4 sm:p-6">
            <h3 class="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Items Delivered</h3>
        ...
        <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-lg bg-white dark:bg-gray-800">
            <div class="mt-3">
                ...
                <div class="mt-3 text-center">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100">Approve Delivery</h3>
                    <div class="mt-2 px-7 py-3">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            Total Items: {{ $delivery->details->sum('quantity_delivered') }} units
                        </p>
                        
                        <form action="{{ route('admin.deliveries.approve', $delivery) }}" method="POST" class="mt-4">
                            @csrf
                            <div class="text-left">
    ...
    <div id="rejectModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-lg bg-white dark:bg-gray-800">
            <div class="mt-3">
                ...
                <div class="mt-3 text-center">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100">Reject Delivery</h3>
                    <div class="mt-2 px-7 py-3">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <form action="{{ route('admin.deliveries.reject', $delivery) }}" method="POST" class="mt-4">
                            @csrf
                            <div class="text-left">
