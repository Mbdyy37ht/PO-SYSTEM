<x-app-layout>
    ...
    <div class="space-y-4 sm:space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4">
            <div>
                <h2 class="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-200">Delivery Approval</h2>
                <p class="mt-1 text-xs sm:text-sm text-gray-600 dark:text-gray-400">Review and approve/reject goods receipt notes</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-4 sm:p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Delivery Number</label>
                    <input type="text" id="filterGRNNumber" placeholder="DEL-2024-00001"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#approvalTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.deliveries.approval') }}",
                    data: function(d) {
                        d.status = $('#filterStatus').val();
                        d.delivery_number = $('#filterGRNNumber').val();
                        d.so_number = $('#filterPONumber').val();
                        d.date_from = $('#filterDateFrom').val();
                    }
                },
                columns: [
                    { data: 'grn_info', name: 'delivery_number' },
                    { data: 'delivery_date', name: 'delivery_date' },
                    { data: 'po_info', name: 'salesOrder.so_number' },
                    ...
                    emptyTable: `
                        <div class="py-12 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 font-medium">No pending deliveries for approval</p>
